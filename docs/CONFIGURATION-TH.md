...
- 30 แท็บเป็นตัวเลือกขั้นสูง ไม่ใช่ค่าเริ่มต้น

ระบบพักการเปิดแท็บใหม่เมื่อ RAM ว่างต่ำกว่า 4 GB หรือ 12% และลดเพดานชั่วคราวเมื่อเกิด timeout, network failure หรือ renderer crash ติดต่อกัน
