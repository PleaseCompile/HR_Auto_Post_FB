...
`tabLimit = 0` หมายถึงเปิดตามจำนวนกลุ่มทั้งหมดโดยไม่มีเพดานจากแอป
...
นี่เป็นคำแนะนำเริ่มต้น ไม่ใช่การรับประกัน เครื่องที่มี Extension หรือโปรแกรมอื่นจำนวนมากอาจต้องลดแท็บ
